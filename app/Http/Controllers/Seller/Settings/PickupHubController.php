...
use App\Http\Requests\Seller\PickupHub\StoreRequest;
use App\Http\Requests\Seller\PickupHub\UpdateRequest;
use App\Library\Services\Seller\Settings\PickupHubService;
...
class PickupHubController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('seller.pages.config.general_settings.pickupHub.index');
    }
    ...
    {
        return view('seller.pages.config.general_settings.pickupHub.create', [
    ...
    public function store(StoreRequest $request): RedirectResponse
    {
        ...
        if ($result) {
            return redirect()->route('seller.config.general_settings.pickup_hub.index')->with('success', $this->pickup_hub_service->message);
        }
    ...
    public function edit(Address $pickupHub)
    {
        ...
        return view('seller.pages.config.general_settings.pickupHub.update', [
            'pickupHub' => $pickupHub,
            'divisions' => Division::active()->get(),
    ...
    public function destroy(Address $pickupHub)
    {
        ...
        if ($pickupHub) {
            return redirect()->route('seller.config.general_settings.pickup_hub.index')->with("success", "Successfully Deleted");
        }
