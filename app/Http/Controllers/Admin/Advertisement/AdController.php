...
use App\Http\Requests\Admin\Advertise\StoreRequest;
use App\Http\Requests\Admin\Advertise\UpdateRequest;
use App\Library\Services\Admin\Advertisement\AdService;
...
class AdController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.pages.advertise.index');
    }
    ...
    public function create(): View
    {
        ...
        return view('admin.pages.advertise.create', [
            'products' => $products,
    ...
    public function store(StoreRequest $request): RedirectResponse
    {
        ...
        if($result) {
            return redirect()->route('admin.ad.index')->with('success', $this->ad_service->message);
        }
    ...
    public function edit(Advertise $ad): View
    {
        ...
        return view('admin.pages.advertise.edit', [
            'ad'        => $ad,
            'products'  => $products,
            'locations' => AdvertiseLocation::active()->get(),
        ]);
    ...
    public function changeStatus(Request $request, Advertise $ad)
    {
        $result = $this->ad_service->changeStatus($ad);
