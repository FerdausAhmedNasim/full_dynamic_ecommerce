...
class CreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'user.email'      => ['nullable', 'string', 'max:255', 'unique:users,email'],
            'user.password'   => ['required', 'string', 'min:8', 'confirmed'],
            'dob'             => ['nullable', 'date'],
            'mobile'          => ['required', 'string', 'max:18', 'min:11', 'unique:users,phone'],
            ...
            'store.logo'       => ['required', 'file', 'max:1500', 'mimes:jpeg,jpg,png,gif'],
