...
class CreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dob'             => ['required', 'date'],
            'mobile'          => ['required', 'string', 'max:18', 'unique:users,phone'],
            ...
            'address.thana_id'       => ['required', 'integer'],
            'address.area_id'        => ['required', 'integer'],
            'address.division_id'    => ['required', 'integer'],
            ...
            'emergencyContact.mobile_number' => ['required', 'string', 'max:18'],
