...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Product Stock
            'sku'           => ['nullable', 'required_without:has_variant', 'string', 'max:255', 'unique:product_stocks,sku,' . $this->product->productStock->id],
            ...
            'product_thumbnail'   => ['nullable', 'file', 'max:512', 'mimes:png,jpg,jpeg,webp,gif', 'dimensions:min_width=750, min_height=750'],
            'images.*'            => ['nullable', 'file', 'max:512', 'mimes:png,jpg,jpeg,webp,gif', 'dimensions:min_width=750, min_height=750'],
