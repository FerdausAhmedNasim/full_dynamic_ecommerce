        ...
        <div class="row">
            <div class="col-5">
                <form method="POST" action="{{ route('seller.login') }}">
                    ...
                    <h3 style="margin-bottom: 15px;font-size: 38px;">{{ __('Seller Login') }}</h3>
                    ...
                    <div class="forEmail">
                        ...
                        <input type="email" class="@error('email') is-invalid @enderror" id="email" name="email"
                            value="{{ !app()->isProduction() ? App\Models\User::where('user_type', 'seller')->first()?->email : '' }}" required autocomplete="email" autofocus placeholder="Email">
                    ...
                    <div class="forPassword">
                        ...
                        <input type="password" placeholder="Password" id="password" value="{{ !app()->isProduction() ? 123456 : '' }}"
