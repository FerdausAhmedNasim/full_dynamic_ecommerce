                            ...
                            <div class="table-responsive mt-3">
                                <table id="purchaseTable" class="table table-hover order-list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="parent-row">
                                            <td>
                                                <img width="50" src="{{ $return?->product?->getThumbnailImage() }}">
                                            </td>
                                            <td>
                                                <span class="product-name"> {{ $return?->product?->getTranslation('short_title') }} </span>
                                                @if ($return?->load('sellerOrderDetails.productStock')?->sellerOrderDetails?->productStock?->variant_ids)
                                                    <br> <small>{{ getProductVariantValue($return?->load('sellerOrderDetails.productStock')?->sellerOrderDetails?->productStock?->variant_ids) }}</small>
                                                @endif
                                            </td>
                                            <td>
                                                {{ $return->product->unit }}
                                            ...
                                            <td class="text-right">
                                                {{ getFormattedAmount($return->sale_price) }}
                                            </td>
...
@include('seller.pages.return.partial.modal_change_status')
@stop
