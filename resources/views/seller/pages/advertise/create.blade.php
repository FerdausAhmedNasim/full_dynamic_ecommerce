...
@section('title', __('New Ad Request'))
...
<div class="content-wrapper">
    ...
    {!! \App\Library\Html::linkBack(route('seller.ad.index')) !!}
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('New Ad Request')) }}</h4>
        </div>
    </div>

    <div class="card shadow-sm">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('seller.ad.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-sm-3">
                                        ...
                                        <div class="file-upload-section">
                                            ...
                                            <div class="input-group col-xs-12">
                                                <input type="text" class="form-control file-upload-info"
                                                    disabled="" readonly
                                                    placeholder="Size: 800x350 and max 1024kB">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control productSelect2" name="product_ids[]" multiple>
                                        ...
                                        @foreach($products as $product)
                                            <option class="text-capitalize" value="{{ $product->thumbnail }}">
...
<script>
    $(document).ready(function() {
        ...
        $('#advertise_location_id').change(function() {
            ...
            if (selectedLocationName == 'flash_sale') {
