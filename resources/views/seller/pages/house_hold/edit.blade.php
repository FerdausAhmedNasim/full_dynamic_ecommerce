...
@section('title', __('Update Household'))
...
<div class="content-wrapper">
    ...
    {!! \App\Library\Html::linkBack( route('seller.profile.index') . '#house-hold') !!}
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Update Household')) }}</h4>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('seller.house_hold.update', $user_house_hold->id) }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-group row @error('number_of_member') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="number_of_member"
                                        value="{{ old('number_of_member', $user_house_hold->number_of_member) }}" placeholder="{{ __('Ex: 10') }}"
                                        required>
                            ...
                            <div class="form-group row @error('person_18_and_over') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="person_18_and_over"
                                        value="{{ old('person_18_and_over', $user_house_hold->person_18_and_over) }}" placeholder="{{ __('Ex: 10') }}"
                                        required>
                            ...
                            <div class="form-group row @error('person_under_18') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="person_under_18"
                                        value="{{ old('person_under_18', $user_house_hold->person_under_18) }}" placeholder="{{ __('Ex: 10') }}"
                                        required>
                            ...
                            <div class="form-group row @error('primary_language') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="primary_language"
                                        value="{{ old('primary_language', $user_house_hold->primary_language) }}" placeholder="{{ __('Enter Language') }}"
                                        required>
                            ...
                            <div class="form-group row @error('secondary_language') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="secondary_language"
                                        value="{{ old('secondary_language', $user_house_hold->secondary_language) }}" placeholder="{{ __('Enter Language') }}"
                                        required>
                            ...
                            <div class="form-group row @error('third_language') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="third_language"
                                        value="{{ old('third_language', $user_house_hold->third_language) }}" placeholder="{{ __('Enter Language') }}"
                                        required>
                                    ...
                                    <div class="d-inline-flex justify-content-start">
                                        <div class="form-check form-check-info mr-5">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="healthy_home_initiative" value="1" required {{ old('healthy_home_initiative', $user_house_hold->healthy_home_initiative) ? 'checked' : '' }}>
                                                Yes
                                                <i class="input-helper"></i></label>
                                        </div>
                                        <div class="form-check form-check-danger">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="healthy_home_initiative" value="0" required {{ !old('healthy_home_initiative', $user_house_hold->healthy_home_initiative) ? 'checked' : '' }}>
                                                No
                                                <i class="input-helper"></i></label>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-inline-flex justify-content-start">
                                        <div class="form-check form-check-info mr-5">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="smoker_status" value="1" required {{ old('smoker_status', $user_house_hold->smoker_status) ? 'checked' : '' }}>
                                                Yes
                                                <i class="input-helper"></i></label>
                                        </div>
                                        <div class="form-check form-check-danger">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="smoker_status" value="0" required {{ !old('smoker_status', $user_house_hold->smoker_status) ? 'checked' : '' }}>
                                                No
                                                <i class="input-helper"></i></label>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-inline-flex justify-content-start">
                                        <div class="form-check form-check-info mr-5">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="pet_in_house" value="1" required {{ old('pet_in_house', $user_house_hold->pet_in_house) ? 'checked' : '' }}>
                                                Yes
                                                <i class="input-helper"></i></label>
                                        </div>
                                        <div class="form-check form-check-danger">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="pet_in_house" value="0" required {{ !old('pet_in_house', $user_house_hold->pet_in_house) ? 'checked' : '' }}>
                                                No
                                                <i class="input-helper"></i></label>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row @error('number_of_pets') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="number_of_pets"
                                        value="{{ old('number_of_pets', $user_house_hold->number_of_pets) }}" placeholder="{{ __('Ex: 10') }}"
                                        required>
                            ...
                            <div class="form-group row @error('type_of_pet') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="type_of_pet"
                                        value="{{ old('type_of_pet', $user_house_hold->type_of_pet) }}" placeholder="{{ __('Type Of Pet') }}"
                                        required>
                                    @error('type_of_pet')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
