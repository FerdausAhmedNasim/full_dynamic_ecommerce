...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('seller.ticket.create') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                            ...
                            <div class="form-group row @error('priority') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2" name="priority" required>
                                        ...
                                        <option class="text-capitalize" value="{{ $index }}" {{(old("priority") == $index) ? "selected" : ""}}>
                                            {{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('priority')
...
@push('scripts')
@vite('resources/seller_assets/js/pages/ticket/create.js')
@endpush
