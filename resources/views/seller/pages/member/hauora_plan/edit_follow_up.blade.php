...
@section('title', __('Update Follow Up'))

@section('content')
<div class="content-wrapper">

    <div class="content-header d-flex justify-content-start">
    {!! \App\Library\Html::linkBack(route('seller.member.hauora_plan.show', $hauoraPlanDetail->hauoraPlan?->id)) !!}
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Update Follow Up')) }}</h4>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body py-sm-4">
            <form method="post" id="hauora_plan-form"
                action="{{ route('seller.member.hauora_plan.follow_up.update', $hauoraPlanDetail->id) }}"
                            ...
                            <div class="col-md-6">
                                <div class="p-sm-3">
                                    <div class="form-group row @error('name') error @enderror">
                                        ...
                                        <div class="col-sm-9">
                                            <h6 id="">{{$hauoraPlanDetail->hauoraPlan?->name}}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="input-group with-icon">
                                                <input type="text" class="form-control datetimepicker-min-today" name="follow_up_date"
                                                    value="{{ old('follow_up_date', getFormattedDateTime($hauoraPlanDetail->hauoraPlan?->follow_up_date)) }}"
                                    ...
                                    <a class="d-flex justify-content-between align-items-center" data-toggle="collapse"
                                        ...
                                        <span class="select-container d-flex align-items-center">
                                            ...
                                            <select class="form-control select-box" id="ratingSelect1"
                                                ...
                                                <option value="1" {{(old("details[ph_rating]", $hauoraPlanDetail->
                                                    ph_rating)==1) ? "selected" : "" }}>1
                                                </option>
                                                <option value="2" {{(old("details[ph_rating]", $hauoraPlanDetail->
                                                    ph_rating)==2) ? "selected" : "" }}>2
                                                </option>
                                                <option value="3" {{(old("details[ph_rating]", $hauoraPlanDetail->
                                                    ph_rating)==3) ? "selected" : "" }}>3
                                                </option>
                                                <option value="4" {{(old("details[ph_rating]", $hauoraPlanDetail->
                                                    ph_rating)==4) ? "selected" : "" }}>4
                                                </option>
                                                <option value="5" {{(old("details[ph_rating]", $hauoraPlanDetail->
                                                    ph_rating)==5) ? "selected" : "" }}>5
                                                </option>
                                            </select>
                                        </span>
                                    </a>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <textarea name="details[ph_strengths]" class="form-control"
                                                rows="6">{{ old('details[ph_strengths]', $hauoraPlanDetail->ph_strengths) }}</textarea>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="text-center mb-1">
                                            ...
                                            <textarea name="details[ph_needs]" class="form-control"
                                                rows="6">{{ old('details[ph_needs]', $hauoraPlanDetail->ph_needs) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-6 ">
                                            ...
                                            <textarea name="details[ph_goals]" class="form-control"
                                                rows="6">{{ old('details[ph_goals]', $hauoraPlanDetail->ph_goals) }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="text-center mb-1">
                                            ...
                                            <textarea name="details[ph_plan]" class="form-control"
                                                rows="6">{{ old('details[ph_plan]', $hauoraPlanDetail->ph_plan) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <a class="d-flex justify-content-between align-items-center" data-toggle="collapse"
                                        ...
                                        <span class="select-container d-flex align-items-center">
                                            ...
                                            <select class="form-control select-box" id="ratingSelect2"
                                                ...
                                                <option value="" selected disabled>1 - 5</option>
                                                <option value="1" {{(old("details[mh_rating]", $hauoraPlanDetail->
                                                    mh_rating)==1) ? "selected" : "" }}>1
                                                </option>
                                                <option value="2" {{(old("details[mh_rating]", $hauoraPlanDetail->
                                                    mh_rating)==2) ? "selected" : "" }}>2
                                                </option>
                                                <option value="3" {{(old("details[mh_rating]", $hauoraPlanDetail->
                                                    mh_rating)==3) ? "selected" : "" }}>3
                                                </option>
                                                <option value="4" {{(old("details[mh_rating]", $hauoraPlanDetail->
                                                    mh_rating)==4) ? "selected" : "" }}>4
                                                </option>
                                                <option value="5" {{(old("details[mh_rating]", $hauoraPlanDetail->
                                                    mh_rating)==5) ? "selected" : "" }}>5
                                                </option>
                                            </select>
                                        </span>
                                    </a>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <textarea name="details[mh_strengths]" class="form-control"
                                                rows="6">{{ old('details[mh_strengths]', $hauoraPlanDetail->mh_strengths) }}</textarea>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="text-center mb-1">
                                                <p style="font-size: 18px;">Needs - What needs to be put in place to
                                            ...
                                            <textarea name="details[mh_needs]" class="form-control"
                                                rows="6">{{ old('details[mh_needs]', $hauoraPlanDetail->mh_needs) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-6 ">
                                            ...
                                            <textarea name="details[mh_goals]" class="form-control"
                                                rows="6">{{ old('details[mh_goals]', $hauoraPlanDetail->mh_goals) }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="text-center mb-1">
                                                <p style="font-size: 18px;">Plan - How will the goals be achieved and
                                            ...
                                            <textarea name="details[mh_plan]" class="form-control"
                                                rows="6">{{ old('details[mh_plan]', $hauoraPlanDetail->mh_plan) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <a class="d-flex justify-content-between align-items-center" data-toggle="collapse"
                                        ...
                                        <span class="select-container d-flex align-items-center">
                                            ...
                                            <select class="form-control select-box" id="ratingSelect3"
                                                ...
                                                <option value="" selected disabled>1 - 5</option>
                                                <option value="1" {{(old("details[sh_rating]", $hauoraPlanDetail->
                                                    sh_rating)==1) ? "selected" : "" }}>1
                                                </option>
                                                <option value="2" {{(old("details[sh_rating]", $hauoraPlanDetail->
                                                    sh_rating)==2) ? "selected" : "" }}>2
                                                </option>
                                                <option value="3" {{(old("details[sh_rating]", $hauoraPlanDetail->
                                                    sh_rating)==3) ? "selected" : "" }}>3
                                                </option>
                                                <option value="4" {{(old("details[sh_rating]", $hauoraPlanDetail->
                                                    sh_rating)==4) ? "selected" : "" }}>4
                                                </option>
                                                <option value="5" {{(old("details[sh_rating]", $hauoraPlanDetail->
                                                    sh_rating)==5) ? "selected" : "" }}>5
                                                </option>
                                            </select>
                                        </span>
                                    </a>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <textarea name="details[sh_strengths]" class="form-control"
                                                rows="6">{{ old('details[sh_strengths]', $hauoraPlanDetail->sh_strengths) }}</textarea>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="text-center mb-1">
                                                <p style="font-size: 18px;">Needs - What needs to be put in place to
                                            ...
                                            <textarea name="details[sh_needs]" class="form-control"
                                                rows="6">{{ old('details[sh_needs]', $hauoraPlanDetail->sh_needs) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-6 ">
                                            ...
                                            <textarea name="details[sh_goals]" class="form-control"
                                                rows="6">{{ old('details[sh_goals]', $hauoraPlanDetail->sh_goals) }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="text-center mb-1">
                                                <p style="font-size: 18px;">Plan - How will the goals be achieved and
                                            ...
                                            <textarea name="details[sh_plan]" class="form-control"
                                                rows="6">{{ old('details[sh_plan]', $hauoraPlanDetail->sh_plan) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <a class="d-flex justify-content-between align-items-center" data-toggle="collapse"
                                        ...
                                        <span class="select-container d-flex align-items-center">
                                            ...
                                            <select class="form-control select-box" id="ratingSelect4"
                                                ...
                                                <option value="" selected disabled>1 - 5</option>
                                                <option value="1" {{(old("details[fh_rating]", $hauoraPlanDetail->
                                                    fh_rating)==1) ? "selected" : "" }}>1
                                                </option>
                                                <option value="2" {{(old("details[fh_rating]", $hauoraPlanDetail->
                                                    fh_rating)==2) ? "selected" : "" }}>2
                                                </option>
                                                <option value="3" {{(old("details[fh_rating]", $hauoraPlanDetail->
                                                    fh_rating)==3) ? "selected" : "" }}>3
                                                </option>
                                                <option value="4" {{(old("details[fh_rating]", $hauoraPlanDetail->
                                                    fh_rating)==4) ? "selected" : "" }}>4
                                                </option>
                                                <option value="5" {{(old("details[fh_rating]", $hauoraPlanDetail->
                                                    fh_rating)==5) ? "selected" : "" }}>5
                                                </option>
                                            </select>
                                        </span>
                                    </a>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <textarea name="details[fh_strengths]" class="form-control"
                                                rows="6">{{ old('details[fh_strengths]', $hauoraPlanDetail->fh_strengths) }}</textarea>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="text-center mb-1">
                                                <p style="font-size: 18px;">Needs - What needs to be put in place to
                                            ...
                                            <textarea name="details[fh_needs]" class="form-control"
                                                rows="6">{{ old('details[fh_needs]', $hauoraPlanDetail->fh_needs) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="details[fh_goals]" class="form-control"
                                                rows="6">{{ old('details[fh_goals]', $hauoraPlanDetail->fh_goals) }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="text-center mb-1">
                                                <p style="font-size: 18px;">Plan - How will the goals be achieved and
                                            ...
                                            <textarea name="details[fh_plan]" class="form-control"
                                                rows="6">{{ old('details[fh_plan]', $hauoraPlanDetail->fh_plan) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
