...
@section('title', __('Client Immunizations'))
@section('content')
...
<div class="content-wrapper">
    ...
    {!! \App\Library\Html::linkBack(route('seller.referral.index')) !!}
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Client immunization')) }}</h4>
        </div>
    </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body py-sm-4">
                            <div class="text-center pb-2">
                                <div class="mb-3">
                                    <table class="table table-bordered" id="immunizationTable">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Name</th>
                                                <th>Immunised By</th>
                                                <th>Immunised Date</th>
                                                <th>Immunised Note</th>
                                                <th>Target Date</th>
                                                <th>Target Note</th>
                                                <th>Status</th>
                                                <th>Operator</th>
...
@push('scripts')
@vite('resources/admin_assets/js/pages/member/immunization/index.js')
@endpush
