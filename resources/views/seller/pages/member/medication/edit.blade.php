...
@section('title', __('Update Medication Plan'))
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        ...
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Update Medication Plan')) }}</h4>
        </div>
    ...
    <div class="card shadow-sm col-md-8">
        <div class="card-body py-sm-4">
            <form method="post" class="validate_form" action="{{ route('seller.member.medication.update', $medication->id) }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-12">
                        <div class="p-sm-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group with-icon">
                                        <input type="text" class="form-control datetimepicker-min-today" name="follow_up_date"
                                            value="{{ old('follow_up_date', getFormattedDateTime($medication->follow_up_date)) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="summernote" name="note">{{ old('note') ?? $medication->note }}</textarea>
                                </div>
                            </div>
