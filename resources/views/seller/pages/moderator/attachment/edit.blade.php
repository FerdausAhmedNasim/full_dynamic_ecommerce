...
<div class="content-wrapper">
    ...
    {!! \App\Library\Html::linkBack(route('admin.user.employee.show', $attachment->attachable_id) . '#tab-attachment') !!}
        <div class="d-block">
    ...
    <div class="card shadow-sm col-sm-6">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.user.employee.attachment.update', $attachment->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-sm-3">
