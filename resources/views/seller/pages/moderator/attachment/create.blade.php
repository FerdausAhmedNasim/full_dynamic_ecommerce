...
<div class="content-wrapper">
    ...
    {!! \App\Library\Html::linkBack(route('admin.user.employee.show', $employee->id) . '#tab-attachment') !!}
        <div class="d-block">
    ...
    <div class="card shadow-sm col-sm-6">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.user.employee.attachment.store', $employee->id) }}" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
