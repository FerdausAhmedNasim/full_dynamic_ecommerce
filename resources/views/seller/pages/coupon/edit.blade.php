...
<div class="content-wrapper">
    ...
    <div class="card shadow-sm">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('seller.coupon.update', $coupon->id) }}"
                            ...
                            <div class="form-group row @error('maximum_discount') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="maximum_discount"
                                        value="{{ old('maximum_discount', $coupon->maximum_discount) }}" placeholder="{{ __('Maximum Discount') }}" required>
