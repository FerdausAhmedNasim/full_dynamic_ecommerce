...
@php
    $route = isset($clone) ? route('seller.product.clone.post', $product->id) : route('seller.product.update', $product->id);
    $route_data_form = isset($clone) ? route('seller.product.getVariants') : route('seller.product.getVariantsEdit', $product->id);
        ...
        <form action="{{ $route }}" method="post" enctype="multipart/form-data" data-form="{{ $route_data_form }}" id="variant">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="productInformation" role="tabpanel">
                    @include('seller.pages.product.partials.update.basicInformation')
                </div>

                <div class="tab-pane" id="productPriceAndStock" role="tabpanel">
                    @include('seller.pages.product.partials.update.priceAndStock')
                </div>

                <div class="tab-pane" id="images" role="tabpanel">
                    @include('seller.pages.product.partials.update.images')
                </div>

                <div class="tab-pane" id="descriptionsAndSpecifications" role="tabpanel">
                    @include('seller.pages.product.partials.update.descriptionsAndSpecifications')
                </div>

                <div class="tab-pane" id="shippingInfo" role="tabpanel">
                    @include('seller.pages.product.partials.update.shipping')
                </div>

                <div class="tab-pane" id="others" role="tabpanel">
                    @include('seller.pages.product.partials.update.others')
                </div>

                <div class="tab-pane" id="seo" role="tabpanel">
                    @include('seller.pages.product.partials.update.seo')
                </div>
