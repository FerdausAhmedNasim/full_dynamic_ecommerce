        ...
        <div class="p-sm-3">
            ...
            <div class="form-group @error('shipping_type') error @enderror">
                ...
                <select class="form-control" name="shipping_type" id="shipping_type" required>
                    <option value="flat_rate" {{ old('shipping_type', $product?->productDetails?->shipping_type) == 'flat_rate' ? 'selected' : '' }}>Flat Rate</option>
                    <option value="free_shipping" {{ old('shipping_type', $product?->productDetails?->shipping_type) == 'free_shipping' ? 'selected' : '' }}>Free Shipping</option>
                </select>
                @error('shipping_type')
            ...
            <div class="shippingFeeDiv form-group @error('shipping_fee') error @enderror 
                {{ old('shipping_type', $product?->productDetails?->shipping_type) == 'free_shipping' ? 'd-none' : '' }}">
                ...
                <input type="number" min="0" step="any" class="form-control" name="shipping_fee"
                    value="{{ old('shipping_fee', $product?->productDetails?->shipping_fee) }}" id="shipping_fee" placeholder="Enter Shipping Fee" />
                @error('shipping_fee') 
                    <p class="error-message">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="form-group row mt-2 @error('shipping_fee_depend_on_quantity') error @enderror">
                ...
                <div class="col-md-9">
                    <label class="custom-switch">
                        <input type="checkbox" value="1" {{ old('shipping_fee_depend_on_quantity', $product?->productDetails?->shipping_fee_depend_on_quantity) == 1 ? 'checked' : '' }} name="shipping_fee_depend_on_quantity" class="custom-switch-input">
            ...
            <div class="form-group row mt-2 @error('cash_on_delivery') error @enderror">
                ...
                <div class="col-md-9">
                    <label class="custom-switch">
                        <input type="checkbox" value="1" {{ old('cash_on_delivery', $product?->cash_on_delivery) == 1 ? 'checked' : '' }} name="cash_on_delivery" class="custom-switch-input">
                        <span class="custom-switch-indicator"></span>
            ...
            <div class="form-group @error('estimated_shipping_days') error @enderror">
                ...
                <input type="text" class="form-control" name="estimated_shipping_days"
                    value="{{ old('estimated_shipping_days', $product?->productDetails?->estimated_shipping_days) }}" id="estimated_shipping_days"
