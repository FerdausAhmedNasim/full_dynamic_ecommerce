...
@section('title', __('Update Bank Account'))
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        ...
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Update Bank Account')) }}</h4>
        </div>
    </div>

    <div class="card shadow-sm">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('seller.bankAccount.update', $bank->id) }}"
                            ...
                            <div class="form-group row @error('bank_name') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="bank_name"
                                        value="{{ $bank->bank_name }}" placeholder="{{ __('Bank Name') }}" required>
                                    @error('bank_name')
                            ...
                            <div class="form-group row @error('branch_name') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="branch_name"
                                        value="{{ $bank->branch_name }}" placeholder="{{ __('Branch Name') }}" required>
                                    @error('branch_name')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row @error('account_name') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="account_name"
                                        value="{{ $bank->account_name }}" placeholder="{{ __('Account Name') }}" required>
                                    @error('account_name')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row @error('account_number') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="account_number"
                                        value="{{ $bank->account_number }}" placeholder="{{ __('Account Number') }}" required>
                            ...
                            <div class="form-group row @error('routing_number') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="routing_number"
                                        value="{{ $bank->routing_number }}" placeholder="{{ __('Routing Number') }}" required>
