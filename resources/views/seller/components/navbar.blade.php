...
$notifications = App\Models\Notification::where('send_date', '<=', now()
                ->format('Y-m-d'))
...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="{{ route('seller.home.dashboard') }}"><img
                src="{{ settings('logo') ? asset(settings('logo')) : Vite::asset(\App\Library\Enum::NO_IMAGE_PATH) }}"
                class="mr-2" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('seller.home.dashboard') }}"><img
                src="{{ settings('logo') ? asset(settings('logo')) : Vite::asset(\App\Library\Enum::NO_IMAGE_PATH) }}"
                alt="logo" /></a>
    </div>
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile">
                <a href="{{ route('seller.clear.cache') }}"
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    @endforeach
                    <p class="mb-0 font-weight-normal float-left dropdown-header"><a class="nav-link" href="{{ route('seller.notification.index') }}">See all</a></p>
            ...
            <li class="nav-item nav-profile dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('seller.profile.shop') }}">
...
@include('seller.pages.notification.partials.modal_show_notification')
