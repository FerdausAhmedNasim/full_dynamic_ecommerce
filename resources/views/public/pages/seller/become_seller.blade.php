        ...
        <div class="row">
                            ...
                            <div class="service-box">
                                <div class="service-svg">
                                    <svg viewBox="0 -31 480 479" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path
                                            d="m114.347656 218.84375 96.003906-96 11.3125 11.3125-96.003906 96.003906zm0 0" />
                                        <path
            ...
            <div class="col-lg-6">
                <div class="form-section mt-2">
                    <div>
                        <div class="vendor-title text-center">
                            <h5>Create an Seller Account</h5>
                            <p>Marketplace is Bangladesh's leading platform for selling online.</p>
                        </div>
                    </div>
                    <div>
                        <form method="post" action="{{ route('public.seller.create') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">

                                <div class="vendor-title text-left">
                                    <h5>Seller Info</h5>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('user.first_name') error @enderror">
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('user.last_name') error @enderror ">
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('user.phone') error @enderror">
                                            <input type="tel" class="form-control" name="user[phone]"
                                                value="{{ old('user.phone') }}" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('user.email') error @enderror">
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('user.password') error @enderror">
                                            <input type="password" class="form-control" name="user[password]"
                                                value="{{ old('user.password') }}" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('user.password_confirmation') error @enderror">
                                            <input type="password" class="form-control"
                                                name="user[password_confirmation]"
                                                value="{{ old('user.password_confirmation') }}" required>
                                ...
                                <div class="vendor-title text-left mt-4">
                                    <h5>Shop Info</h5>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('store_lan.store_name') error @enderror">
                                            <input type="text" class="form-control" name="store_lan[store_name]"
                                                value="{{ old('store_lan.store_name') }}" required>
                                            <label for="mail">Store Name *</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating @error('store_lan.store_tagline') error @enderror">
                                            <input type="text" class="form-control" name="store_lan[store_tagline]"
                                                value="{{ old('store_lan.store_tagline') }}">
                                            <label for="mail">Store Tagline (optional)</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('store.license_no') error @enderror">
                                            <input type="tel" class="form-control" name="store[license_no]"
                                                value="{{ old('store.license_no') }}">
                                            <label for="mail">License Number (optional)</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3">
                                        <div
                                            class="form-floating theme-form-floating search-box @error('store.logo') error @enderror">
                                            <input type="file" class="form-control" name="store[logo]"
                                                onchange="readURL(this,0)" placeholder="Logo (72*72)">
                                                <label for="mail">Shop Logo (optional)</label>
                                            @error('store.logo')
                                            <p class="error-message">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    </div>
                                    <img src="" class="blur-up mt-2 lazyload update_img img-thumbnail d-none" alt="">
                                </div>

                                @php
                                    $termsConditions = collect(json_decode(settings('seller_agreement'), true));
                                @endphp
                                <div class="col-12">
                                    <button class="btn btn-md mt-3 theme-bg-color text-white mb-3">Submit</button>
...
<section class="business-section section-b-space">
    <div class="container-fluid-lg">
        <div class="vendor-title mb-5">
            <h5>Doing Business Is Really Easy</h5>
        </div>
