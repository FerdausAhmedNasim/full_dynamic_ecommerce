...
@section('title', settings('app_title') ? settings('app_title') : 'About Us')
    ...
    <div class="container-fluid-lg">
        <div class="row gx-xl-5 gy-xl-0 g-3 ratio_148_1">
            <div class="col-xl-6 col-12">
                <div class="about-img">
                    <img src="{{ $page->image ? $page->getImage() : Vite::asset(\App\Library\Enum::ABOUT_IMAGE) }}" alt="">
                </div>
            </div>
                ...
                <div class="fresh-contain p-center-left">
                    <div>
                        ...
                        <div class="delivery-list">
                            <p class="text-content">{{ $about?->meta_description }}</p>
                            ...
                            <ul class="delivery-box">
                                <li>
                                    <div class="delivery-box">
                                        <div class="delivery-icon">
                                            <img data-src="../assets/svg/3/delivery.svg" class="blur-up lazyload" alt="">
                                        </div>
                                ...
                                <li>
                                    <div class="delivery-box">
                                        <div class="delivery-icon">
                                            <img data-src="../assets/svg/3/leaf.svg" class="blur-up lazyload" alt="">
                                        </div>
...
{{-- <section class="team-section section-lg-space">
    <div class="container-fluid-lg">
        <div class="about-us-title text-center">
            ...
            <h2 class="center">team member</h2>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="slider-user product-wrapper">
                    <div>
                        <div class="team-box">
                            <div class="team-image">
                                <img src="../assets/images/about/person1.jpg" class="img-fluid blur-up lazyload" alt="">
                            </div>
                    ...
                    <div>
                        <div class="team-box">
                            <div class="team-image">
                                <img src="../assets/images/about/person2.jpg" class="img-fluid blur-up lazyload" alt="">
                            </div>
                    ...
                    <div>
                        <div class="team-box">
                            <div class="team-image">
                                <img src="../assets/images/about/person3.jpg" class="img-fluid blur-up lazyload" alt="">
                            </div>
                    ...
                    <div>
                        <div class="team-box">
                            <div class="team-image">
                                <img src="../assets/images/about/person4.jpg" class="img-fluid blur-up lazyload" alt="">
                            </div>
                ...
                <div class="slider-4-half product-wrapper">
                        ...
                        <div class="reviewer-box">
                            ...
                            <div class="reviewer-profile">
                                <div class="reviewer-image">
                                    <img src="../assets/images/inner-page/user/1.jpg" class="blur-up lazyload" alt="">
                                </div>
                    ...
                    <div>
                        <div class="reviewer-box">
                            ...
                            <div class="reviewer-profile">
                                <div class="reviewer-image">
                                    <img src="../assets/images/inner-page/user/2.jpg" class="blur-up lazyload" alt="">
                                </div>
                    ...
                    <div>
                        <div class="reviewer-box">
                            ...
                            <div class="reviewer-profile">
                                <div class="reviewer-image">
                                    <img src="../assets/images/inner-page/user/3.jpg" class="blur-up lazyload" alt="">
                                </div>
                    ...
                    <div>
                        <div class="reviewer-box">
                            ...
                            <div class="reviewer-profile">
                                <div class="reviewer-image">
                                    <img src="../assets/images/inner-page/user/4.jpg" class="blur-up lazyload" alt="">
                                </div>
                ...
                <div class="slider-5 ratio_87">
                    ...
                    <div>
                        <div class="blog-box">
                            <div class="blog-image">
                                <a href="blog-detail.html" class="rounded-3">
                                    <img src="../assets/images/veg-2/blog/5.jpg" class="bg-img blur-up lazyload" alt="">
                                </a>
                            </div>
