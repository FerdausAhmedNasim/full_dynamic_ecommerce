                        ...
                        @foreach ($cartDataBySeller as $seller_id => $sellerData)
                            <div class="checkout-items shadow-lg">
                                @php
                                    ...
                                    $coupon = $sellerData
                                        ->first()
                                        ->product->seller->coupons->where('active', true)
                                ...
                                <div class="checked-item">
                                    ...
                                    @foreach ($sellerData as $cartItem)
                                            ...
                                            <div class="col-md-7">
                                                <div class="d-flex flex-column flex-md-row align-items-md-center gap-2">
                                                    ...
                                                    <div class="text-start">
                                                        <p class="m-0">{{ $cartItem->product->getTranslation('title') }}
                                                        </p>
                                                        @if ($cartItem->variant)
                                                ...
                                                <div class="h-100 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="price-col">
                                                        ...
                                                        <input type="hidden" id="discountPrice"
                                                            value="{{ $cartItem->price - $cartItem->product->calculatePriceAfterDiscount($cartItem->price) }}">

                                                        <span
                                                            class="ms-2 productPrice">{{ getFormattedAmount(
                                        ...
                                        @php
                                            ...
                                            $itemTotalAfterDiscount =
                                                ...
                                                $cartItem->quantity * $cartItem->ezzico_discount;
                                    ...
                                    <div
                                        class="d-flex justify-content-between align-items-center gap-3 mt-3 sellerItemFooter">
                                        <div></div>
                                        ...
                                        @if (count($coupon) > 0)
                                            <div class="coupon-cart">
                                                ...
                                                <div class="coupon-box input-group">
                                                    <input type="text" class="form-control coupon-apply"
                                                        name="coupon_code" placeholder="Enter Coupon Code Here...">
                                        ...
                                        @else
                                            ...
                                            <input type="hidden" name="seller_coupon_discount" value="0"
                                                class="seller_coupon_discount">
                                            <input type="hidden" class="form-control coupon-apply" name="coupon_code"
                                                value="">
                                        @endif
                                        ...
                                        <input type="hidden" name="seller_ezzico_discount"
                                            class="seller_ezzico_discount" value="{{ $sellerEzzicoDiscount }}">
                                        ...
                                        <div class="total-price text-right">
                                            ...
                                            <div>
                                                ...
                                                @if ($saved > 0)
                                                    <h6 class="theme-color">Saved <span
                                                            class="savePrice">{{ getFormattedAmount($saved) }}</span></h6>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="summery-box p-4 shadow-lg mt-4">
                            ...
                            <ul class="summery-total">
                                ...
                                <li class="list-total mt-3">
                                    ...
                                    @endphp
                                    <h4 class="price total-price orderTotalPrice">{{ getFormattedAmount($orderTotal) }}
                                    </h4>
                                </li>
                            </ul>

                            <input type="hidden" name="advance_shipping_cost"
                                value="{{ settings('advance_shipping_cost') }}" id="advance_shipping_cost">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-xxl-12 mb-4">
                                        <div
                                            class="form-floating theme-form-floating form-group @error('name') error @enderror">
                                    ...
                                    <div class="col-xxl-12 mb-4">
                                        <div
                                            class="form-floating theme-form-floating form-group @error('phone') error @enderror">
                                    ...
                                    <div class="col-xxl-12 mb-4">
                                        <div
                                            class="form-floating theme-form-floating form-group @error('address') error @enderror">
                                    ...
                                    <p style=" font-size: 16px">আপনার অর্ডারটি নিশ্চিত করতে নাম, মোবাইল নাম্বার, বিভাগ,
                                        জেলা, থানা সঠিকভাবে পূরণ করুন এবং অ্যাড বাটন এ ক্লিক করুন। প্রয়োজনে ফোন করুন
                                        01575468540।</p>
                                </div>
                                <div class="d-flex justify-content-center">
                                    <button
                                        class="btn theme-bg-color text-white btn-md w-100 mt-4 fw-bold btn-place-order btn2"
