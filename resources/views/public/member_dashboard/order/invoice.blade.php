...
<head>
    ...
    <link rel="icon"
        href="{{ settings('favicon') ? asset(settings('favicon')) : Vite::asset(\App\Library\Enum::ICON_PATH) }}"
        type="image/x-icon">
                                            ...
                                            <div class="details-box">
                                                <div class="address-box">
                                                    <ul>
                                                        ...
                                                        <li>{{ $order?->address ? $order?->address : $order?->order_person_address }}</li>
                                                ...
                                                <div class="address-box">
                                                    <ul>
                                                        <li class="theme-color">Name : <span
                                                                class="text-content">{{ $order?->customer ? $order?->customer?->full_name : $order?->order_person_name }}</span>
                                                        </li>
                                                        <li class="theme-color">Phone : <span
                                                                class="text-content">{{ $order?->customer ? $order?->customer?->phone : $order?->order_person_phone }}</span>
                                                        </li>
                            ...
                            <div class="table-responsive table-borderless">
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($sellerOrder->sellerOrderDetails->load('product',
                                        'sellerOrder.seller') as $key => $orderDetail)
                                        @php
                                ...
                                <table>
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ getFormattedAmount($order->collected_amount) }}
                                            </td>
                                        </tr>

                                        <tr>
                                            <td colspan="4" class="text-right">Due Amount</td>
                                            <td class="text-center">{{ getFormattedAmount($order->amount_to_be_collect) }}
                                            </td>
                                        </tr>
                                        @endif
                                ...
                                <ul>
                                    <li>
                                        <a class="btn theme-bg-color text-white rounded"
                                            href="{{ route('dashboard.order.invoice.download', $order->id) }}">Export As
                                            PDF</a>
                                    </li>
                                    <!-- <li>
