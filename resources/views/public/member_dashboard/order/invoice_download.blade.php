...
<body>
                        ...
                        <tr class="border-top">
                            ...
                            <td>
                                <div class="text-grey-m2">
                                    ...
                                    <span class="text-600">Website: <a class="text-primary-m1" target="_blank"
                                            href="{{ settings('website') && settings('website') != '' ? settings('website') : '#' }}">{{ settings('website') && settings('website') != '' ? settings('website') : 'N/A' }}</a></span><br />
    ...
    align-items: center;">
        ...
        <div class="border-top">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        @php
                            ...
                            $subtotal = 0;
                        @endphp
                        @foreach ($sellerOrder->sellerOrderDetails->load('product', 'sellerOrder.seller') as $key => $orderDetail)
                            @php
                            ...
                            <tr>
                                ...
                                <td class="text-left">{{ $orderDetail->product->getTranslation('title') }}
                                    @if ($orderDetail?->load('productStock')?->productStock?->variant_ids)
                                        <br> <small>
                                            {{ getProductVariantValue($orderDetail?->load('productStock')?->productStock?->variant_ids) }}
                                        </small>
                                    @endif
                                </td>
            ...
            @endforeach
            <table class="mr-0 pr-0">
                <tfoot class="mr-0 pr-0">
                    <tr class="mr-0 pr-0">
                    ...
                    <tr class="mr-0 pr-0">
                        <th colspan="5" class="text-right">Total
                            <small>({{ numberToWord($order->total_amount) }})</small></th>
                    ...
                    <tr class="mr-0 pr-0">
                        ...
                        <td class="text-center">{{ getFormattedAmount($order->collected_amount) }}</td>
                    </tr>

                    <tr class="mr-0 pr-0">
                        <td colspan="5" class="text-right">Due Amount</td>
                        <td class="text-center">{{ getFormattedAmount($order->amount_to_be_collect) }}</td>
                    </tr>
                    @endif
        ...
        <div
            style="display:flex;justify-content: space-around;background-color: #0da487;color: white;padding: 10px;margin-top: 63px;">
