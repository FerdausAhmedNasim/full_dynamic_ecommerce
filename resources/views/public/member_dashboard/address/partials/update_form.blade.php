...
$districts = App\Models\District::where('division_id', $address->area->division_id)->active()->get();
$thanas = App\Models\Thana::where('district_id', $address->area->district_id)->active()->get();
$areas = App\Models\Area::where('thana_id', $address->area->thana_id)->active()->get();
@endphp
