...
<body>
                ...
                <td colspan="2">
                    <table>
                        <tr class="border-top">
                            <td>
                                <h4> Purchase From:</h4>
                                <span class="">{{ $order?->supplier->name ?? 'N/A' }}</span> <br />
                                Address: {{ $order?->supplier?->address ?? 'N/A' }}<br />
                                Phone: {{ $order?->supplier->phone ?? 'N/A' }}<br />
                            </td>
                            ...
                            <td>
                                <div class="text-grey-m2">
                                    ...
                                    <span class="text-600">Address: {{ (getCompanyAddress() && getCompanyAddress() != '') ? getCompanyAddress() : 'N/A' }}</span><br />
                                    <span class="text-600">Phone: {{ settings('phone') && settings('phone') != '' ? settings('phone') : 'N/A' }}</span><br />

                                    <span class="text-600">Email: {{ settings('email') && settings('email') != '' ? settings('email') : 'N/A' }}</span><br />
    ...
    justify-content: center;
    align-items: center;">
            <span class="mx-2">Invoice Number: {{ $order->invoice_id }}</span>
            <span class="mx-2">Date: {{ date('jS F Y', strtotime(now())) }}</span>
