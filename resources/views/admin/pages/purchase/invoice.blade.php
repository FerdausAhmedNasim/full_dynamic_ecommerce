        ...
        <div class="page-header text-primary-m1-d2">
            <h1 class="page-title text-secondary-d1">
                ...
                <small class="page-info">
                    ...
                    Number: {{ $order->invoice_id }}
                </small>
            </h1>
            <div class="page-tools">
                <div class="action-buttons">
                    <a class="btn bg-white btn-light mx-1px text-95"
                        href="{{ route('admin.purchase.invoice.download',$order->id)}}" data-title="Print">
                            ...
                            <div class="text-grey-m2">
                                ...
                                <div class="text-grey-m2">
                                    ...
                                    <div class="my-1"><i
                                        ...
                                        <b class="text-600">{{ (getCompanyAddress() && getCompanyAddress() != '') ? getCompanyAddress() : 'N/A' }}</b></div>

                                    <div class=""><i class="fa fa-phone text-secondary"></i>
                                        <b class="text-600">{{ settings('phone') && settings('phone') != '' ? settings('phone') : 'N/A' }}</b></div>
                                    <div class="my-1"><i class="fa fa-envelope fa-flip-horizontal text-secondary"></i>
                                        <b class="text-600">{{ settings('email') && settings('email') != '' ? settings('email') : 'N/A' }}</b></div>
                        ...
                        <div class="text-95 col-sm-12 align-self-start d-sm-flex justify-content-center"
                            ...
                            <div class="text-grey-m2">
                                ...
                                <div class="mx-3 d-inline"><i class="fa fa-circle text-primary-m1 text-xs mr-1"></i>
                                    <span class="text-600 text-90">Invoice Number:</span> {{ $order->invoice_id }}
                                </div>
                                <div class="mx-3 d-inline"><i class="fa fa-circle text-primary-m1 text-xs mr-1"></i>
                            ...
                            <tbody>
                                ...
                                <tr class="parent-row">
                                    ...
                                    <td class="text-left">
                                        ...
                                        {{-- <br> <small>{{ getProductAttributeValue($stock) }}</small> --}}
                                    </td>
                                    ...
                                    <td class="sub-total-td text-right">
                                        <span>
                                            {{ getFormattedAmount($stock->quantity * $stock->purchase_price) }}
                                        </span>
                                    </td>
...
{{--
                                ...
                                <tr>
                                    <th colspan="5" class="text-right text-150">Total <small>({{ numberToWord($order->total_amount) }})</small></th>
                        ...
                        <div>
                            ...
                            <a class="btn mb-2 mr-2 btn-success px-4 float-right mt-3 mt-lg-0"
                                href="{{ route('admin.purchase.show', $order->id) }}">
