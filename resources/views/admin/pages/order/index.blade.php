                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 mb-2">
                            <select class="form-control" required id="range">
                                ...
                                {{-- <option value="quantity_low_high)">Order Quantity(Low > High)</option> --}}
                                {{-- <option value="quantity_high_low)">Order Quantity(High > Low)</option> --}}
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-5 col-xl-5 col-lg-12 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 mb-2 d-flex justify-content-end">
                            <button style="background: var(--btn-primary); color: var(--btn-primary-text)" class="btn mr-1" onclick="filterOrders()">Filter</button>
...
@push('scripts')
@vite('resources/admin_assets/js/pages/order/index.js')
@endpush
