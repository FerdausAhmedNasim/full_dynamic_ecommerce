        ...
        <div class="p-sm-3" id="productService">
            ...
            <div class="row">
                <div class="col-sm-4 form-group  @error('product_service_title') error @enderror">
                    ...
                    <input type="text" class="form-control" name="product_service_title[]" maxlength="30" required value="{{ old('product_service_title') ? implode(',', old('product_service_title')) : ''}}" placeholder="{{ __('Product Service Title') }}">
                ...
                <div class="col-sm-4 form-group  @error('product_service_sub_title') error @enderror">
                    ...
                    <input type="text" class="form-control" name="product_service_sub_title[]" maxlength="30" required value="{{ old('product_service_sub_title') ? implode(',', old('product_service_sub_title')) : ''}}" placeholder="{{ __('Product Service Sub Title') }}">
                ...
                <div class="col-sm-2 form-group  @error('product_service_order') error @enderror">
                    ...
                    <input type="number" class="form-control" name="product_service_order[]" min="1" max="3" required value="{{ old('product_service_order') ? implode(',', old('product_service_order')) : ''}}" placeholder="{{ __('Product Service Order') }}">
