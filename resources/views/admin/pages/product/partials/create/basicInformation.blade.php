            ...
            <div class="row">
                ...
                <div class="col-sm-6 form-group  @error('weight') error @enderror">
                    ...
                    <input type="number" min="0" step="any" class="form-control" name="weight"
                        value="{{ old('weight') }}" placeholder="{{ __('Weight') }}" id="weight" required>
                    @error('weight')
                        <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-sm-6 form-group  @error('dimension') error @enderror">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <input type="number" min="0" step="any" class="form-control" name="length"
                                value="{{ old('length') }}" placeholder="{{ __('Length') }}" id="length">
                        </div>
                        <div class="col-md-4">
                            <input type="number" min="0" step="any" class="form-control" name="width"
                                value="{{ old('width') }}" placeholder="{{ __('Width') }}" id="width">
                        </div>
                        <div class="col-md-4">
                            <input type="number" min="0" step="any" class="form-control" name="height"
                                value="{{ old('height') }}" placeholder="{{ __('Height') }}" id="height">
                        </div>
                    </div>
                ...
                <div class="col-sm-6 form-group  @error('barcode') error @enderror">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="barcode" value="{{ old('barcode') }}"
                            id="barcode" placeholder="{{ __('Barcode') }}">
                ...
                <div class="col-sm-12 form-group  @error('tags') error @enderror">
                    ...
                    <input type="text" name="tags[]" value="{{ old('tags') ? implode(',', old('tags')) : '' }}"
                        class="form-control tokenfield" id="productTags" placeholder="Write & Hit Enter" />
                    @error('tags')
                        <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
