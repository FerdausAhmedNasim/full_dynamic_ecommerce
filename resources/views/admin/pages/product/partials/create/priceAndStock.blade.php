        ...
        <div class="p-sm-3">
            ...
            <div class="row mb-4">
                <div class="col-sm-6 form-group  @error('purchase_price') error @enderror">
                    <label class="col-form-label">{{ __('Purchase Price Per Unit') }}</label>
                    <input type="number" min="0" step="any" class="form-control" name="purchase_price"
                        value="{{ old('purchase_price') }}" placeholder="{{ __('0.00') }}" required>
                ...
                <div class="col-sm-6 form-group  @error('unit_price') error @enderror">
                    <label class="col-form-label required">{{ __('Sell Price Per Unit') }}</label>
