        ...
        <div class="p-sm-3">
            <div class="row">
                ...
                <div class="col-sm-6 form-group @error('meta_keywords') error @enderror">
                    ...
                    <input type="text" name="meta_keywords[]" value="{{ old('meta_keywords') ? implode(',', old('meta_keywords')) : '' }}" class="form-control tokenfield" id="metaKeywords" placeholder="Write & Hit Enter" style="width: 100%" />
                    @error('meta_keywords')
                        <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
