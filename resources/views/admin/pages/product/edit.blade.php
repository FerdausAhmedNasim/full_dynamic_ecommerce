...
@php
    $route = isset($clone) ? route('admin.product.clone.post', $product->id) : route('admin.product.update', $product->id);
    $route_data_form = isset($clone) ? route('admin.product.getVariants') : route('admin.product.getVariantsEdit', $product->id);
    $title = isset($clone) ? __('Clone Product') : __('Update Product');
@endphp
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header d-flex justify-content-start">
            ...
            <div class="d-block">
                <h4 class="content-title">{{ isset($clone) ? strtoupper(__('Clone Product')) : strtoupper(__('Update Product')) }}</h4>
            </div>
        </div>
        ...
        <form action="{{ $route }}" method="post" enctype="multipart/form-data" data-form="{{ $route_data_form }}" id="variant">
            @csrf
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="productInformation" role="tabpanel">
                    @include('admin.pages.product.partials.update.basicInformation')
                </div>

                <div class="tab-pane" id="productPriceAndStock" role="tabpanel">
                    @include('admin.pages.product.partials.update.priceAndStock')
                </div>

                <div class="tab-pane" id="images" role="tabpanel">
                    @include('admin.pages.product.partials.update.images')
                </div>

                <div class="tab-pane" id="descriptionsAndSpecifications" role="tabpanel">
                    @include('admin.pages.product.partials.update.descriptionsAndSpecifications')
                </div>

                <div class="tab-pane" id="shippingInfo" role="tabpanel">
                    @include('admin.pages.product.partials.update.shipping')
                </div>

                <div class="tab-pane" id="others" role="tabpanel">
                    @include('admin.pages.product.partials.update.others')
                </div>

                <div class="tab-pane" id="seo" role="tabpanel">
                    @include('admin.pages.product.partials.update.seo')
                </div>
...
@include('admin.assets.tokenfield')
@include('admin.assets.dropMeImageUploader')
@include('admin.assets.toastr')
