...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form action="{{ route('admin.product.store') }}" method="post" enctype="multipart/form-data" data-form="{{ route('admin.product.getVariants') }}" data-for="add" id="variant">
            @csrf

            <div class="tab-content">

                <div class="tab-pane active" id="productInformation" role="tabpanel">
                    @include('admin.pages.product.partials.create.basicInformation')
                </div>

                <div class="tab-pane" id="productPriceAndStock" role="tabpanel">
                    @include('admin.pages.product.partials.create.priceAndStock')
                </div>

                <div class="tab-pane" id="images" role="tabpanel">
                    @include('admin.pages.product.partials.create.images')
                </div>

                <div class="tab-pane" id="descriptionsAndSpecifications" role="tabpanel">
                    @include('admin.pages.product.partials.create.descriptionsAndSpecifications')
                </div>

                <div class="tab-pane" id="shippingInfo" role="tabpanel">
                    @include('admin.pages.product.partials.create.shipping')
                </div>

                <div class="tab-pane" id="others" role="tabpanel">
                    @include('admin.pages.product.partials.create.others')
                </div>

                <div class="tab-pane" id="seo" role="tabpanel">
                    @include('admin.pages.product.partials.create.seo')
                </div>
