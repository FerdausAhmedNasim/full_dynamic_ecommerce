...
<div class="content-wrapper">
    ...
    <div class="row pt-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    <h4>Update Attribute</h4><hr>
                    <form method="post" action="{{ route('admin.attribute.update', $attribute->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row @error('name') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name"
                                    value="{{ old('name', $attribute->name) }}" placeholder="{{ __('Name') }}"
                                    required>
                                @error('name')
