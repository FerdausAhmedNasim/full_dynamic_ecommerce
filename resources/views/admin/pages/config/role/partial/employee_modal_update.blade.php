<!-- Modal -->
<div class="modal fade" id="updateEmployeeRoleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="updateEmployeeRoleForm" onsubmit="updateEmployeeRole(event, this)">
      <input type="hidden" name="id" value="">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel2"> {{ __('Update Employee Role') }}</h5>
