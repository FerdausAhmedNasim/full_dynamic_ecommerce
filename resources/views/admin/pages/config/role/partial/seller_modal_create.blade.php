<!-- Modal -->
<div class="modal fade" id="createSellerRoleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">

    <form id="createSellerRoleForm" onsubmit="createSellerRole(event, this)" action="{{ route('admin.config.role.create.api', 'seller') }}">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel3"><i class="fas fa-plus"></i> {{ __('New Seller Role') }}</h5>
