<!-- Modal -->
<div class="modal fade" id="updateSellerRoleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="updateSellerRoleForm" onsubmit="updateSellerRole(event, this)">
      <input type="hidden" name="id" value="">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel4"> {{ __('Update Seller Role') }}</h5>
