<!-- Modal -->
<div class="modal fade" id="createEmployeeRoleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
  <div class="modal-dialog" role="document">

    <form id="createEmployeeRoleForm" onsubmit="createEmployeeRole(event, this)" action="{{ route('admin.config.role.create.api', 'employee') }}">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel1"><i class="fas fa-plus"></i> {{ __('New Employee Role') }}</h5>
