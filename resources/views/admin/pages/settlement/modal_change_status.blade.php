                                ...
                                <div class="form-group row @error('status') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="select form-control" name="status" id="status"
                                            ...
                                            @foreach(\App\Library\Enum::getPayoutStatusType() as $key => $status)
                                                <option value="{{ $status }}" {{ old('status', \App\Library\Enum::PAYOUT_STATUS_PENDING)  == $key ? "selected" : "" }}> {{ $status }}</option>
                                            @endforeach
                                        </select>
                                        @error('status')
