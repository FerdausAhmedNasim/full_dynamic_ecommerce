<div class="row">
    <div class="col-12">
        ...
        <form method="post" action="{{ route('admin.user.employee.security.update', $employee->id) }}" enctype="multipart/form-data">
            @csrf

            @if(auth()->user()->role()->slug == \App\Library\Enum::USER_TYPE_SUPER_ADMIN
            || $user->user_type == \App\Library\Enum::USER_TYPE_ADMIN &&
            $user->role()->slug != \App\Library\Enum::USER_TYPE_SUPER_ADMIN)
            <hr>
