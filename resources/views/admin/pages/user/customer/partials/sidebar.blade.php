            ...
            <ul class="nav nav-tabss nav-tabs-vertical" role="tablist">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link {{ $currentSegment === 'show' ? 'active' : ''}}"
                        href="{{ route('admin.user.customer.show', $user->id) }}">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link {{ $currentSegment === 'details' ? 'active' : ''}}" href="{{ route('admin.user.customer.show.details', $user->id) }}">
