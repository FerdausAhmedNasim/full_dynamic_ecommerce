...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content-header d-flex justify-content-start">
            ...
            <div class="d-block">
                <h4 class="content-title">{{ strtoupper(__('New Customer')) }}</h4>
            </div>
        ...
        <div class="card shadow-sm">
            <div class="card-body py-sm-4">
                <form method="post" action="{{ route('admin.user.customer.store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="p-sm-3">
                                ...
                                <div class="form-group row @error('full_name') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="full_name"
                                            value="{{ old('full_name') }}" placeholder="{{ __('Full Name') }}" required>
                                        @error('full_name')
                                ...
                                <div class="form-group row @error('gender') error @enderror">
                                    <label class="col-sm-3 col-form-label" for="name">{{ __('Gender') }}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group with-icon">
                                        <input type="text" name="dob" id="dob"
                                            class="form-control datepicker-max-today" value="{{ old('dob') }}"
