...
@section('title', 'Seller Category Create')
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        ...
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Seller Category Create' )) }}</h4>
        </div>
    </div>
    ...
    <div class="card shadow-sm col-lg-8  col-md-12 mt-3">
        <div class="card-body py-sm-4">
            <form method="post" class="form" action="{{ route('admin.user.seller.category.create', $user->id??'') }}"
                ...
                <div class="p-sm-3">
                    ...
                    <div class="form-group row @error('commission_rate') error @enderror">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="commission_rate" value="{{ old('commission_rate') }}"
