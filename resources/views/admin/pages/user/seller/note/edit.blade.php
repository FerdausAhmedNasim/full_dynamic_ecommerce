...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        ...
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Note Edit' )) }}</h4>
        </div>
    </div>
    ...
    <div class="card shadow-sm col-lg-8  col-md-12 mt-3">
        <div class="card-body py-sm-4">
            <form method="post" class="form" action="{{ route('admin.user.seller.note.update', $note->id??'') }}"
                    ...
                    <div class="form-group row @error('title') error @enderror">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="title"
                                value="{{ old('title', $note->title) }}" placeholder="{{ __('Title') }}" required>
                            @error('title')
                    ...
                    <div class="form-group row @error('description') error @enderror">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="summernote" name="description"
                                placeholder="Write here Description About Note....">{{ old('description', $note->title) }}</textarea>
