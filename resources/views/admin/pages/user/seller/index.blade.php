...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-between">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Sellers' )) }}</h4>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <div id="filterArea" class="d-inline-flex justify-content-start">
                <ul class="nav nav-pills nav-pills-success"  role="tablist" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link tab-menu" href="#" onclick="filterStatus('-1')">All</a>
                    </li>
                </ul>
            </div>
...
@push('scripts')
@vite('resources/admin_assets/js/pages/user/seller/index.js')
@endpush
