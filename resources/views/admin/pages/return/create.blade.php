...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" class="" action="{{ route('admin.order.return', $sellerOrder->id) }}">
                @csrf
                                        ...
                                        <tbody>
                                            ...
                                            <tr  class="parent-row">
                                                ...
                                                <input type="hidden" class="total_amount"
                                                    name="total_amount" value="0" step="any" required>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th class="text-center">
                                                    <h4 class="total-quantity" id="total-qty">0</h4>
                                                </th>
                                                <th class="text-center">
                                                    <h4>Total </h4>
                                                </th>
                                                <th class="text-center">
                                                    <h4 class="total-price" id="total-amount">$0.0</h4>
                                                </th>
                                            </tr>
                                        </tfoot>
                                        @endif
