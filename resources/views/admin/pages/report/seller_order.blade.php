...
@section('title', 'Seller Sales Report')
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-between">
        <div class="d-block">
            <h4 class="content-title"> {{ strtoupper(__('Seller Sales Report' )) }}</h4>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-6">
                    <select class="form-control" id="seller_id" multiple>
                        @foreach($shops as $shop)
                            <option class="text-capitalize" value="{{ (int) $shop->seller_id }}">
                                {{ $shop->getTranslation('store_name') }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-6">
                    <select class="form-control" id="order_status" multiple>
                        @foreach($orderStatus as $index => $value)
...
@push('scripts')
@vite('resources/admin_assets/js/pages/report/seller_order.js')
@endpush
