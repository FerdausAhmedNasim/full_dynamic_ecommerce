...
var table = $('#dataTable').DataTable({
    ...
    autoWidth: false,
    ajax: {
        url: BASE_URL + "/courier-pricing-plans",
    },
    columns: columns,
    dom: 'Bfrtip',
    buttons: [
        ...
        { html: '<a class="dt-button buttons-collection" href="'+ BASE_URL +'/courier-pricing-plans/create"><i class="fas fa-plus"></i> Add New</a>' }
    ],
