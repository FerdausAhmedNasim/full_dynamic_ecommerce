...
var table = $('#questionDataTable').DataTable({
    ...
    autoWidth: false,
    ajax: {
        url: BASE_URL + "/products/" + "questions",
    },
    columns: columns,
    dom: 'Bfrtip',
    buttons: [
        ...
        { html: colVisibility('#questionDataTable', column_defs) },
...
window.clickAnswerModal = function (id, product_id)
{
    loading('show');
...
window.storeAnswer = function (e, t)
{
    ...
    const product_id = $(answerForm).find("input[name='product_id']").val();
