...
var table = $('#dataTable').DataTable({
    ...
    autoWidth: false,
    ajax: {
        url: BASE_URL + "/area-settings/thana/",
    },
    columns: columns,
    dom: 'Bfrtip',
    buttons: [
        ...
        { html: '<a class="dt-button buttons-collection" href="'+ BASE_URL +'/area-settings/thana/create"><i class="fas fa-plus"></i> Add New</a>' }
    ],
...
window.changeThanaSubrubs = function (e, route)
{
    e.preventDefault();
    confirmFormModal(route, 'Confirmation', 'Are you sure Update Status. ');
