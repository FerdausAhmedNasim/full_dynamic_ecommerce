...
$("#homeSubRoad").keyup(function() {
    ...
    if (homeSubRoad == '') {
        $("#error-homeSubRoad").text('Enter State.');
    ...
    if (homeSubRoad == null) {
        $("#error-homeSubRoad").text("State is Required.");
        $("#homeSubRoad").addClass("box_error");
        error = true;
    } else {
...
$("#postalSubRoad").keyup(function() {
    ...
    if (postalSubRoad == '') {
        $("#error-postalSubRoad").text('Enter State.');
    ...
    if (postalSubRoad == null) {
        $("#error-postalSubRoad").text("State Required.");
        $("#postalSubRoad").addClass("box_error");
        error = true;
    } else {
...
$(".ts_next_btn").click(function() {
    ...
    if ($("#homeSubRoad").val() == '') {
        ...
        if (homeSubRoad != homeSubRoad) {
            $("#error-homeSubRoad").text('State Required.');
            error = true;
        } else {
            $("#error-homeSubRoad").text('');
            // error = false;
