...
var ticketTable = $('#dataTable').DataTable({
    ...
    autoWidth: false,
    ajax: {
        url: BASE_URL + "/users/sellers/notes/"+ userId,
    },
    columns: columns,
    dom: 'Bfrtip',
    buttons: [
        ...
        { html: '<a class="dt-button buttons-collection" href="'+ BASE_URL + '/users/sellers/notes/'+ userId + '/create"><i class="fas fa-plus"></i> Add New</a>' }
    ],
