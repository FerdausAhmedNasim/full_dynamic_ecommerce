...
let column_defs = [
    {"className": "text-center", "targets": [0,2,3,3]}
];
...
var table = $('#dataTable').DataTable({
    ...
    buttons: [
        ...
        { html: '<a class="dt-button buttons-collection" href="'+ BASE_URL +'/withdraws/create"><i class="fas fa-plus"></i> Add New</a>' }
    ],
