/*-----------------------------------------------------------------------------------
 ...
 Template Name: Ezzico
 Template URI: themes.pixelstrap.com/Ezzico
...
// 13. Wishlist Jsdropdown-category
// 14. Loader Js
...
(function ($) {
    ...
    $('.three-grid').on('click', function (e) {
        $(".product-list-section").removeClass("row-cols-xxl-5 row-cols-xxl-3 row-cols-xl-2 row-cols-lg-2 row-cols-md-2 row-cols-2 list-style").addClass("row-cols-xxl-3 row-cols-xl-2 row-cols-lg-2 row-cols-md-2 row-cols-2");
    });
...
var contentwidth = $(window).width();
if (contentwidth < "767") {
    $('.onhover-category-box').css("display", "none");
    $('.sub-category-title').css("display", "none");
    ...
    $(".category-title-box .category-title-name").append('<span class="according-menu">+</span>');
    $(".category-title-name").on("click", function () {
        $(".category-title-name")
            .removeClass("active")
            .find("span")
            .replaceWith('<span class="according-menu">+</span>');
        $(".category-title-box .sub-category-title").slideUp("normal");
        if ($(this).next().is(":hidden") == true) {
            $(this).addClass("active");
            $(this)
                .find("span")
